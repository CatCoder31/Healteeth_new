      ...
      <div class="page-wrapper">
        ...
        <thead>
            ...
            while($row = mysqli_fetch_array($run_data))
            {
                ...
                <td class='text-left'>$service_name</td>
                <td class='text-left'>$service_price</td>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
       <center> <a href='delete_service.php?service_id=$id' class='btn btn-danger'>Delete</a></center>
      </div>
            ...
            <div class='container' id='profile'> 
                <div class='row'>
                    <div class='col-sm-12 col-md-6'>
                        ...
                        <strong>Service:</strong> $s_name <br>
                        <strong>Price:</strong> $s_price <br>
                        </p>
                        <!-- Split button -->
                    </div>
                </div>
...
<div id='edit$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <form action='edit_service.php?service_id=$id' method='post' enctype='multipart/form-data'>
        
        <div class='form-row'>
            <div class='form-group col-md-12'>
                <label for='c_name'>Category Name</label>
                <input type='text' class='form-control' name='ca_name' placeholder='Enter Category Name' value='$cc_name' disabled>
            </div>

            <div class='form-group col-md-12'>
                <label for='s_name'>Service Name</label>
                <input type='text' class='form-control' name='se_name' placeholder='Enter Email' value='$ss_name'>
            </div>
          
        
            <div class='form-group col-md-12'>
                <label for='s_price'>Description</label>
                <input type='text' class='form-control' name='se_price' placeholder='Enter Email' value='$ss_price'>
            </div>
