                                 ...
                                 <div class="form-outline mb-4">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                       ...
                                       <div class="modal-body text-center">
                                          ...
                                          <p class="text-center2">Verify your <span style="color: #65cad7">Account!</span></p>
                                          <p class="text-centerModal">Email is not verified yet. Please check your email for verification instructions.</p>
